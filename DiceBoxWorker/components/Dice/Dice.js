...
let meshes = {}, themes = {}, diceCombos = {}, count = 1, lights = [], defaultTheme = 'nebula', worker
...
class Dice {
  ...
  static async loadModels(options) {
    const models = await SceneLoader.ImportMeshAsync("", "./DiceBoxWorker/assets/models/diceMeshes.glb")
