...
async function loadStandardMaterial(theme) {
  ...
  let diceTexture = await importTextureAsync(`./DiceBox/assets/themes/${theme}/albedo.jpg`)
  let diceBumpTexture = await importTextureAsync(`./DiceBox/assets/themes/${theme}/normal.jpg`)
